  ...
  <section class="bg-white">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md sm:text-center">
        ...
        >
          Formuła 1 na wyciągnięcie ręki! Zapisz się do naszego newslettera i
          ciesz się wyścigowymi informacjami.
        </p>
        <form action="#">
          <div
          ...
          >
            ...
            <div>
              <button
                type="submit"
                class="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-red-500 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-red-600 focus:ring-4 focus:ring-primary-300"
              >
                Subskrybuj
              </button>
            </div>
          ...
          >
            ...
            <a href="#" class="font-medium text-red-700"
